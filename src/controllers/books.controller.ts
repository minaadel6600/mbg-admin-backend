...
class BooksController {
  ...
  public getPage = async (
    ...
    try {
      ...
      const books = await this.bookService.getPageOfBooks(currentPage, pageSize, searchKey);
      const booksCount = await this.bookService.getBooksCount();
  ...
  public getAllBooks = async (
    ...
    try {
      const books = await this.bookService.getAllBooksService();
